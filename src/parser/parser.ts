...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "DescriptionDefinition$ebnf$1$subexpression$1$ebnf$1", "symbols": ["InitialVariables"], "postprocess": id},
    {"name": "DescriptionDefinition$ebnf$1$subexpression$1$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "DescriptionDefinition$ebnf$1$subexpression$1", "symbols": [(lexer.has("openBracket") ? {type: "openBracket"} : openBracket), "ws", "DescriptionDefinition$ebnf$1$subexpression$1$ebnf$1", (lexer.has("closedBracket") ? {type: "closedBracket"} : closedBracket), "ws"]},
